...
class Cache {
  ...
  public:
	...
	void AccessSingleLine( bool hit, uint32_t AccessType, const uint64_t address, Byte * Data, uint32_t length ) ;
    ...
    Cache_Set * GetCacheSet( uint32_t index ) { return m_Sets[index ] ;}
