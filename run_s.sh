stdbuf -o0 ./MemSystem --conf ./cache_setting1.cfg --skip_inst 100000000 --inst_num 500000000 --input /home/luo/spec2006/BenchmarkTrace/400-perlbench_T.dat --output ./result/400-perlbench_s.out >& ./log/B400-perlbench_s.txt &

stdbuf -o0 ./MemSystem --conf ./cache_setting1.cfg --skip_inst 100000000 --inst_num 500000000 --input /home/luo/spec2006/BenchmarkTrace/401-bzip2_T.dat --output ./result/401-bzip2_s.out >& ./log/B401-bzip2_s.txt &

stdbuf -o0 ./MemSystem --conf ./cache_setting1.cfg --skip_inst 100000000 --inst_num 500000000 --input /home/luo/spec2006/BenchmarkTrace/403-gcc_T.dat --output ./result/403-gcc_s.out >& ./log/B403-gcc_s.txt &
...
#stdbuf -o0 ./MemSystem -conf ./cache_buffer.cfg -inst_num 500000000 -input /home/luo/spec2006/BenchmarkTrace/429-mcf_T.dat -output ./result/429-mcf.out -clu ../result/429-mcf_CLUB.txt >& ./log/B429-mcf.txt &
